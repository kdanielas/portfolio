const translations = {
  en: {
    ...
    cs1_role1: "Lead Designer — Journey 2 (Portfolio Understanding)",
    cs1_role2: "Contributed across all 3 journeys for design alignment",
    cs1_role3: "Collaborated with PM, engineers, and cross-functional stakeholders",

    cs1_team: "Team",
    cs1_team1: "Lead UX Strategist + me (Product Designer)",


    cs1_scroll: "Scroll down to see the project",

    cs1_challenge_title: "The Challenge",
    cs1_challenge_p1: "Two weeks of discovery workshops surfaced the same friction, over and over:",
    ...
    cs1_challenge_new_li3: "Educational content existed but was disconnected from real decision moments",
    cs1_challenge_new_li4: "Users couldn't tell which recommendations were actually personalized to them",
    cs1_challenge_new_li5: "The friction eroded confidence in trading and portfolio management overall",
    ...
    cs1_opportunity_p1: "The goal wasn't to build an AI. It was to make the platform feel like it was on the user's side. We reframed the experience around three things:",
    ...
    cs1_feature1_p1: "Try a trade, see the impact, build confidence — then decide. A risk-free space to practice before putting real money on the line.",
    cs1_feature1_bold: "Why it matters:",
    cs1_feature1_li1: "Reduces fear of making the wrong move",
    cs1_feature1_li2: "Builds confidence through experimentation, not instruction",

    cs1_feature2_title: "Scenario Exploration",
    cs1_feature2_title2: "What If",

    cs1_feature2_p1: "A \"What If?\" tool that makes the consequences of decisions visible before users commit.",
    cs1_feature2_bold: "Design decision:",
    cs1_feature2_li1: "Visual clarity over technical complexity — scenarios need to feel immediate, not analytical.",
    ...
    cs1_feature5_li2: "Answers questions in context — not in a separate screen",
    cs1_feature5_li3: "Surfaces next steps based on the user's portfolio",
    cs1_feature5_li4: "Builds trust through transparency — not just answers, but reasoning",
    cs1_feature5_why_title: "Design decision",
    cs1_feature5_why_text: "In early concepts we explored a dedicated AI hub — a separate screen for guidance. Users ignored it. Moving guidance inline, to the exact moment a decision is being made, is what made it feel useful.",
    ...
    cs1_outcomes_title: "Five months of work, ready for testing",

    cs1_outcomes_p1: "This was exploratory work — future-state vision, not a shipped product. Across the engagement:",
    cs1_outcomes_new_li1: "High-fidelity concepts for all 3 journeys, explored through user testing",
    cs1_outcomes_new_li2: "Cross-functional team aligned across product, engineering, and business",
    cs1_outcomes_new_li3: "Experience concepts tied to KPIs: NPS, CSAT, trade volume, and advice adoption",
    cs1_outcomes_new_li4: "Reusable guided decision-making patterns that scale across the platform",
    cs1_outcomes_new_li5: "A phased roadmap — from near-term clarity to longer-term personalization",
    cs1_outcomes_new_li6: "Handoff documentation for future development teams",
  ...
  es: {
    ...
    cs1_role1: "Diseñadora líder — Journey 2 (Comprensión de la cartera)",
    cs1_role2: "Colaboré en los 3 journeys para mantener la alineación del diseño",
    cs1_role3: "Trabajé junto a PM, ingenieros y stakeholders multifuncionales",
    cs1_role4: "Prototipado",
    cs1_role5: "Exploración de Concepto",
    cs1_role6: "AI-Powered Experiencias Impulsadas por IA",
    cs1_team: "Equipo",
    cs1_team1: "Estratega UX principal + yo (Product Designer)",
    cs1_scroll: "Desliza hacia abajo para ver el proyecto",

    cs1_challenge_title: "El desafío",
    cs1_challenge_p1: "Dos semanas de talleres de discovery revelaron la misma fricción, una y otra vez:",
    cs1_challenge_bold: "A través de discovery y research, identificamos fricciones recurrentes:",
    cs1_challenge_new_li1: "La información del portafolio estaba fragmentada entre cuentas, dificultando ver el panorama completo",
    cs1_challenge_new_li2: "Las decisiones de trading carecían de claridad respecto a riesgo, diversificación e implicaciones fiscales",
    cs1_challenge_new_li3: "Existía contenido educativo y de asesoría, pero era difícil de encontrar y estaba desconectado de los momentos reales de decisión",
    cs1_challenge_new_li4: "Los usuarios no entendían bien qué recomendaciones eran personalizadas para ellos, ni por qué",
    cs1_challenge_new_li5: "Estos procesos de alta fricción reducían la confianza general en el trading y la gestión del portafolio",
    ...
    cs1_opportunity_p1: "El objetivo no era construir una IA. Era lograr que la plataforma se sintiera del lado del usuario. Replanteamos la experiencia en torno a tres ideas:",
    cs1_opportunity_li1: "Mostrar el insight correcto en el momento adecuado",
    cs1_opportunity_li2: "Hacer visibles las consecuencias antes de que el usuario confirme una acción",
    cs1_opportunity_li3: "Guiar sin imponer",
    ...
    cs1_solution_p1: "No es un chatbot. Es una capa de acompañamiento integrada en los momentos que importan, dentro de flujos que el usuario ya conoce.",
    cs1_solution_p2: "Cada decisión volvía a una misma pregunta: ¿esto ayuda al usuario a entender lo que ocurre y a actuar con confianza?",
    ...
    cs1_feature1_p1: "Simula una operación, observa el impacto y gana confianza antes de decidir. Un espacio sin riesgo para practicar antes de invertir dinero real.",
    cs1_feature1_bold: "Por qué es importante:",
    cs1_feature1_li1: "Reduce el miedo a tomar la decisión equivocada",
    cs1_feature1_li2: "Genera confianza a través de la experimentación, no de instrucciones",

    cs1_feature2_title: "Simulador de escenarios",
    cs1_feature2_title2: "¿Y si...?",
    cs1_feature2_p1: "Una herramienta \"¿Y si...?\" que hace visibles las consecuencias de una decisión antes de que el usuario la confirme.",
    ...
    cs1_feature3_title: "Inteligencia previa a la operación",
    ...
    cs1_feature5_li1: "Explica las decisiones en lenguaje sencillo",
    cs1_feature5_li2: "Responde preguntas en el mismo contexto, no en una pantalla aparte",
    cs1_feature5_li3: "Sugiere los próximos pasos según la cartera del usuario",
    cs1_feature5_p2: "Esto da lugar a un modelo híbrido:",
    cs1_feature5_li4: "Genera confianza a través de la transparencia — no solo respuestas, sino el razonamiento detrás de ellas",
    cs1_feature5_li5: "Soporte bajo demanda cuando el usuario lo solicita",

    cs1_feature5_why_title: "Decisión de diseño",
    cs1_feature5_why_text: "En los primeros conceptos exploramos un hub de IA dedicado — una pantalla separada para la orientación. Los usuarios la ignoraban. Integrar la orientación directamente, en el momento exacto en que se toma una decisión, fue lo que la hizo sentir útil.",
    ...
    cs1_outcomes_title: "Cinco meses de trabajo, listos para testear",

    cs1_outcomes_p1: "Aunque el proyecto tuvo un carácter exploratorio y conceptual, generó un impacto significativo:",
    cs1_outcomes_new_li1: "Conceptos de alta fidelidad para los 3 journeys, validados mediante pruebas con usuarios",
    cs1_outcomes_new_li2: "Equipo multifuncional alineado entre producto, ingeniería y negocio",
    cs1_outcomes_new_li3: "Conceptos de experiencia vinculados a KPIs: NPS, CSAT, volumen de operaciones y adopción de asesoría",
    cs1_outcomes_new_li4: "Patrones reutilizables de toma de decisiones guiada, escalables a toda la plataforma",
    cs1_outcomes_new_li5: "Un roadmap por fases — desde claridad a corto plazo hasta personalización a largo plazo",
    cs1_outcomes_new_li6: "Documentación de handoff para futuros equipos de desarrollo",
