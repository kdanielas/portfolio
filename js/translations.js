const translations = {
  en: {
    ...
    cs1_challenge_new_li1: "Portfolio information was fragmented across accounts, making it hard to see the full picture",
    cs1_challenge_new_li2: "Trade decisions lacked clarity around risk, diversification, and tax implications",
    cs1_challenge_new_li3: "Advice and educational content existed, but were difficult to discover and disconnected from real decision-making moments",
    cs1_challenge_new_li4: "Users struggled to understand which recommendations were personalized to them, and why",
    cs1_challenge_new_li5: "These high-friction processes reduced confidence in trading and portfolio management overall",
    ...
    cs1_approach_li1: "Ran 3 cross-functional workshops involving product, engineering, design and business stakeholders to align on vision, priorities and AI opportunities.",
    ...
    cs1_users_subtitle: "The platform needed to support a diverse investment audience, from experienced wealth-management clients to a new generation of digitally-native investors.",
    cs1_user1_name: "Experienced investors",
    cs1_user1_li1: "Higher portfolio complexity",
    cs1_user1_li2: "Expect advanced tools and portfolio visibility",
    cs1_user1_li3: "Need faster access to insights and advisory support",

    cs1_user2_name: "Emerging digital investors",
    cs1_user2_li1: "Comfortable with digital products",
    cs1_user2_li2: "Expect intuitive, self-service experiences",
    cs1_user2_li3: "Need confidence and guidance when making investment decisions",
    cs1_users_shared: "Shared need:",
    cs1_users_shared_text: "Understanding portfolio performance and risk, accessing relevant advice at the right moment, exploring decisions before committing, building confidence through clear, contextual guidance",
    ...
    cs1_feature5_li3: "The system suggests next steps based on user context",
        cs1_feature5_li4: "Guidance is embedded directly into existing workflows rather than separated into a dedicated AI destination.",
    ...
    cs1_outcomes_new_li1: "Translated an emerging AI strategy into actionable product opportunities and MVP initiatives.",
    cs1_outcomes_new_li2: "Helped align 4 cross-functional stakeholders around a single vision for AI-assisted investing.",
    cs1_outcomes_new_li3: "Tested 3 concept directions before converging on an embedded AI guidance model.",
    cs1_outcomes_new_li4: "Defined experience concepts aligned with business goals including engagement, advice adoption and retention.",
    cs1_outcomes_new_li5: "Established a phased roadmap to support future growth among existing and next-generation investors.",
    cs1_outcomes_new_li6: "Created reusable patterns for AI-assisted decision-making across the investing journey.",
